...
func TestValidateTable(t *testing.T) {
	...
	cases := []tc{
		...
		{"mtp_adaptive ok", func(c *Config) { c.Engine.MTPAdaptive = "3:1-4,1:5-16" }, true},
		{"mtp_adaptive single range ok", func(c *Config) { c.Engine.MTPAdaptive = "1:5-16" }, true},
		{"mtp_adaptive needs mtp", func(c *Config) { c.Engine.MTPAdaptive = "3:1-4"; c.Engine.MTP = 0 }, false},
		{"mtp_adaptive overlap", func(c *Config) { c.Engine.MTPAdaptive = "3:1-8,1:5-16" }, false},
		{"mtp_adaptive tokens 5", func(c *Config) { c.Engine.MTPAdaptive = "5:1-4" }, false},
		{"mtp_adaptive garbage", func(c *Config) { c.Engine.MTPAdaptive = "3>1-4" }, false},
		{"ple_readahead ok", func(c *Config) { c.Engine.ReadAhead = 2048 }, true},
		{"ple_readahead negative", func(c *Config) { c.Engine.ReadAhead = -1 }, false},
